package com.hyf.prince.provider;
        ...
        Versioned // since 1.6
{
     ...
     *    data binding
     */
    public EntsJsonProvider(Annotations... annotationsToUse)
    {
        this(null, annotationsToUse);
    }

    public EntsJsonProvider(ObjectMapper mapper)
    {
     ...
     *   support
     */
    public EntsJsonProvider(ObjectMapper mapper, Annotations[] annotationsToUse)
    {
    ...
    public EntsJsonProvider configure(DeserializationConfig.Feature f, boolean state) {
        _mapperConfig.configure(f, state);
        return this;
    }

    public EntsJsonProvider configure(SerializationConfig.Feature f, boolean state) {
        _mapperConfig.configure(f, state);
        return this;
    }

    public EntsJsonProvider configure(JsonParser.Feature f, boolean state) {
        _mapperConfig.configure(f, state);
        return this;
    }

    public EntsJsonProvider configure(JsonGenerator.Feature f, boolean state) {
        _mapperConfig.configure(f, state);
        return this;
    }

    public EntsJsonProvider enable(DeserializationConfig.Feature f, boolean state) {
        _mapperConfig.configure(f, true);
        return this;
    }

    public EntsJsonProvider enable(SerializationConfig.Feature f, boolean state) {
        _mapperConfig.configure(f, true);
        return this;
    }

    public EntsJsonProvider enable(JsonParser.Feature f, boolean state) {
        _mapperConfig.configure(f, true);
        return this;
    }

    public EntsJsonProvider enable(JsonGenerator.Feature f, boolean state) {
        _mapperConfig.configure(f, true);
        return this;
    }

    public EntsJsonProvider disable(DeserializationConfig.Feature f, boolean state) {
        _mapperConfig.configure(f, false);
        return this;
    }

    public EntsJsonProvider disable(SerializationConfig.Feature f, boolean state) {
        _mapperConfig.configure(f, false);
        return this;
    }

    public EntsJsonProvider disable(JsonParser.Feature f, boolean state) {
        _mapperConfig.configure(f, false);
        return this;
    }

    public EntsJsonProvider disable(JsonGenerator.Feature f, boolean state) {
        _mapperConfig.configure(f, false);
        return this;
    }
        ...
        throws IOException
    {
        ...
        Object obj = mapper.readValue(jp, mapper.constructType(genericType));
        
//         if (ContextPagination.class.isAssignableFrom(obj.getClass())) {
//     		User user = (User)request.getAttribute(CacheBase.USERINFO);
//     		if (user != null) {
//	     		ContextPagination context = (ContextPagination)obj;
